        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px' }}>
          {team.map((member, index) => (
            <div key={index} style={{ backgroundColor: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1)' }}>
              ...
              {/* Description in Paragraph Format */}
              <div style={{ padding: '20px' }}>
                ...
                <p style={{ color: '#64748b', fontSize: '14px', lineHeight: '1.7', textAlign: 'justify' }}>
                  {member.desc}
                </p>
              </div>
            </div>
