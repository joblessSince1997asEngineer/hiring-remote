  ...
  return (
    <form action={action} className="space-y-6">
      ...
      <div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              name="description"
              placeholder="A brief 2-3 line summary of the role..."
              required
              rows={3}
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="What will this person do day-to-day? One per line."
              rows={4}
              className={inputClass + ' resize-none'}
            />
          </div>
          ...
          <div>
            ...
            <textarea
              name="requirements"
              placeholder="Must-have skills, experience, qualifications. One per line."
              rows={4}
              className={inputClass + ' resize-none'}
            />
          </div>
          ...
          <div>
            ...
            <textarea
              name="niceToHave"
              placeholder="Bonus skills, extra qualifications (optional)"
              rows={2}
              className={inputClass + ' resize-none'}
            />
          </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            />
            <p className="text-xs text-slate-400 mt-1">Used for candidate matching</p>
          </div>

          <div>
            <label className={labelClass}>Application Deadline</label>
            <input name="applicationDeadline" type="date" className={inputClass} />
            <p className="text-xs text-slate-400 mt-1">Optional — leave empty for rolling</p>
          </div>
        </div>
      </div>
      ...
      <button
        type="submit"
        disabled={pending}
        className="w-full bg-black text-white py-4 rounded-full font-bold hover:bg-slate-800 disabled:opacity-60"
      >
